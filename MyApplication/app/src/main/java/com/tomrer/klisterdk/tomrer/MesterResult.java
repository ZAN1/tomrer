...
//java new
        ...
        double dd1 = fromUregn.get(4)*100;
       ...
       // String kantplade1Text = String.valueOf(dd1);
        ...
        kantPlade1.setText(ddd1 + " cm");
        double ss1 = fromUregn2.get(5)*100;
